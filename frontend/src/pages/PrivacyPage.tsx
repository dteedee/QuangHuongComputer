                    ...
                    <div className="space-y-6 text-gray-700">
                        ...
                        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-8">
                            <p className="text-sm">
                                ...
                                quyền của mình, vui lòng <Link to="/contact" className="text-accent font-bold">liên hệ với chúng tôi</Link> hoặc
                                email: <a href="mailto:privacy@qhcomputer.com" className="text-accent font-bold">privacy@qhcomputer.com</a>
                            </p>
                        </div>
                    </div>
                </div>
