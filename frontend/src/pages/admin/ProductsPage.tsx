                    ...
                    <div className="flex flex-col lg:flex-row items-stretch gap-4">
                        ...
                        <div className="relative flex-1 group">
                            ...
                            <input
                                ...
                                className="w-full pl-14 pr-10 py-4 bg-gray-50 border-none rounded-xl text-sm font-medium text-gray-900 focus:ring-2 focus:ring-accent/10 transition-all outline-none"
                            />
                            {filters.search && (
                                <button
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            {(filters.search || filters.categoryId || filters.brandId || filters.stockFilter !== 'all' || filters.status !== 'active') && (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-4 text-sm font-semibold text-gray-500 hover:text-accent hover:bg-blue-50 rounded-xl transition-all"
                                >
                                    <RefreshCw size={16} />
                                    Đặt lại
                                </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {filteredProducts?.map((product) => (
                            <motion.div
                                layout
                                key={product.id}
                                className="group relative bg-white rounded-[2.5rem] p-6 border border-gray-100 shadow-sm hover:shadow-sm hover:border-gray-200 transition-all duration-300"
                            >
                                <div className="relative aspect-square rounded-[2rem] bg-gray-50 overflow-hidden mb-6 flex items-center justify-center p-8">
                                    ...
                                    {product.oldPrice && product.oldPrice > product.price && (
                                        <div className="absolute top-4 left-4 bg-accent text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">SALE</div>
                                    )}
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1">
                                        <div className="flex items-center justify-between">
                                            <span className="text-xs font-bold text-gray-400 uppercase">{uniqueCategories?.find(c => c.id === product.categoryId)?.name || 'Danh mục'}</span>
                                    ...
                                    <div className="flex items-center justify-between pt-2 border-t border-gray-50">
                                        ...
                                        <button onClick={() => handleOpenModal(product)} className="w-10 h-10 rounded-xl bg-gray-900 text-white flex items-center justify-center hover:bg-gray-700 transition-all">
                ...
                <div className="flex items-center justify-between py-10">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="w-12 h-12 flex items-center justify-center rounded-xl border border-gray-100 hover:bg-gray-50 disabled:opacity-30 transition-all"
                        >
                            <ChevronLeft size={20} />
                        </button>
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-5xl bg-white rounded-[3rem] shadow-md overflow-hidden flex flex-col max-h-[90vh]"
                        >
                            {/* Modal Header */}
                                                ...
                                                <div className="flex-1 space-y-6 w-full">
                                                    <div className="grid grid-cols-1 gap-4">
                                                        <div className="space-y-2">
                                                            <span className="text-xs font-bold text-gray-400 uppercase">Tùy chọn 1: Dán URL</span>
                                                            <input
                                                                name="imageUrl"
                                                                id="imageUrlInput"
                                                        ...
                                                        <div className="relative">
                                                            ...
                                                            <div className="relative flex justify-center text-xs font-bold text-gray-400 uppercase bg-white px-2">Hoặc</div>
                                                        </div>

                                                        <div className="space-y-2">
                                                            <span className="text-xs font-bold text-gray-400 uppercase">Tùy chọn 2: Tải ảnh lên</span>
                                                            <div className="flex gap-3">
                                                                <label className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-gray-900 text-white rounded-xl cursor-pointer hover:bg-black transition-all active:scale-95 shadow-lg shadow-gray-900/10">
                                                                    <Upload size={18} />
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center justify-between">
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-xs text-gray-400 font-medium">Các ảnh này sẽ xuất hiện trong phần chi tiết sản phẩm.</p>
                                                </div>
                                            ...
                                            {gallery.length > 0 ? (
                                                ...
                                                <div className="py-12 border-2 border-dashed border-gray-100 rounded-[2rem] flex flex-col items-center justify-center text-gray-300 gap-3">
                                                    <ImageIcon size={40} />
                                                    <p className="text-xs font-bold uppercase">Chưa có ảnh liên quan</p>
                                                </div>
                                            )}
                                        </div>
                                    </motion.div>
                            ...
                            <div className="px-10 py-8 bg-white border-t border-gray-100 flex items-center gap-4 sticky bottom-0 z-10 font-sans">
                                <button type="button" onClick={() => setIsModalOpen(false)} className="flex-1 py-4 bg-gray-50 text-gray-500 text-sm font-bold rounded-xl hover:bg-gray-100 transition-all active:scale-95">Hủy</button>
                                <button type="submit" form="mainForm" disabled={createMutation.isPending || updateMutation.isPending} className="flex-[2] py-4 bg-accent text-white text-sm font-bold rounded-xl shadow-sm shadow-blue-500/15 hover:bg-black transition-all active:scale-95 disabled:opacity-50">
