    ...
    <div className="sticky top-28 space-y-5">
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="bg-gray-900 px-5 py-4 text-white flex justify-between items-center">
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wide">Giỏ hàng của bạn</h3>
            <p className="text-white/50 text-xs">{items.length} sản phẩm</p>
          </div>
      ...
      <div className="bg-red-50/50 rounded-xl p-4 border border-red-100 flex items-center gap-3">
        ...
        <div>
          <h4 className="font-bold text-gray-900 text-sm">Thanh toán an toàn</h4>
          <p className="text-[11px] text-gray-500">Dữ liệu cá nhân được bảo mật theo tiêu chuẩn SSL</p>
        </div>
      </div>
    </div>
  );
