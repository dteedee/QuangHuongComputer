...
namespace Inventory.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260819030808_AddExpectedDeliveryDateToPurchaseOrder")]
    partial class AddExpectedDeliveryDateToPurchaseOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryModule.Domain.LandedCost", b =>
                {
                    ...
                    b.HasIndex("GRNId")
                        .HasDatabaseName("IX_LandedCost_GRN");
            ...
            modelBuilder.Entity("InventoryModule.Domain.POApprovalRequest", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderId")
                        .HasDatabaseName("IX_POApprovalRequest_PO");
            ...
            modelBuilder.Entity("InventoryModule.Domain.POApprovalRule", b =>
                {
                    ...
                    b.HasIndex("SortOrder")
                        .HasDatabaseName("IX_POApprovalRule_SortOrder");
            ...
            modelBuilder.Entity("InventoryModule.Domain.PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex("RequisitionId")
                        .HasDatabaseName("IX_PurchaseOrder_Requisition");
            ...
            modelBuilder.Entity("InventoryModule.Domain.PurchaseRequisition", b =>
                {
                    ...
                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("IX_PR_Number");

                    b.HasIndex("RequestedBy")
                        .HasDatabaseName("IX_PR_RequestedBy");
            ...
            modelBuilder.Entity("InventoryModule.Domain.PurchaseReturn", b =>
                {
                    ...
                    b.HasIndex("GRNId")
                        .HasDatabaseName("IX_PurchaseReturn_GRN");

                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("IX_PurchaseReturn_Number");

                    b.HasIndex("SupplierId")
                        .HasDatabaseName("IX_PurchaseReturn_Supplier");
            ...
            modelBuilder.Entity("InventoryModule.Domain.RequestForQuotation", b =>
                {
                    ...
                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("IX_RFQ_Number");

                    b.HasIndex("RequisitionId")
                        .HasDatabaseName("IX_RFQ_Requisition");
            ...
            modelBuilder.Entity("InventoryModule.Domain.StockReservation", b =>
                {
                    ...
                    b.HasIndex("ProductId", "VariantId", "Status")
            ...
            modelBuilder.Entity("InventoryModule.Domain.SupplierQuotationItem", b =>
                {
                    ...
                    b.HasIndex("ProductId")
                        .HasDatabaseName("IX_SQI_Product");
            ...
            modelBuilder.Entity("InventoryModule.Domain.PurchaseRequisitionItem", b =>
                {
                    b.HasOne("InventoryModule.Domain.PurchaseRequisition", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("InventoryModule.Domain.PurchaseReturnItem", b =>
                {
                    b.HasOne("InventoryModule.Domain.PurchaseReturn", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("InventoryModule.Domain.SupplierQuotationItem", b =>
                {
                    b.HasOne("InventoryModule.Domain.SupplierQuotation", null)
                        .WithMany("Items")
