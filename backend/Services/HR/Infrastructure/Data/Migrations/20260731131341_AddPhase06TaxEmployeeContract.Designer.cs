...
namespace HR.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260731131341_AddPhase06TaxEmployeeContract")]
    partial class AddPhase06TaxEmployeeContract
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HR.Domain.Allowance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("IX_Allowance_EmployeeId");
            ...
            modelBuilder.Entity("HR.Domain.AllowanceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("TaxFreeMonthlyLimit")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("HR.Domain.AttendanceRule", b =>
                {
                    ...
                    b.Property<decimal>("LateFineMoneyPerMinute")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("OvertimeHolidayRate")
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)");

                    b.Property<decimal>("OvertimeNightBonus")
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)");

                    b.Property<decimal>("OvertimeSundayRate")
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)");

                    b.Property<decimal>("OvertimeWeekdayRate")
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)");
            ...
            modelBuilder.Entity("HR.Domain.Dependent", b =>
                {
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("IX_Dependent_EmployeeId");

                    b.HasIndex("EmployeeId", "DeductionEndDate")
                        .HasDatabaseName("IX_Dependent_Employee_Active");

                    b.ToTable("Dependents", "hr");
                });
            ...
            modelBuilder.Entity("HR.Domain.EmployeeAsset", b =>
                {
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("IX_EmployeeAsset_EmployeeId");

                    b.ToTable("EmployeeAssets", "hr");
                });

            modelBuilder.Entity("HR.Domain.EmploymentContract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("IX_Contract_EmployeeId");

                    b.HasIndex("Type", "EndDate")
                        .HasDatabaseName("IX_Contract_Type_EndDate");
            ...
            modelBuilder.Entity("HR.Domain.MonthlyTimesheet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("LeaveDaysPaid")
                        .HasColumnType("integer");

                    b.Property<int>("LeaveDaysUnpaid")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("OvertimeHoursHoliday")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");
                    ...
                    b.Property<decimal>("OvertimeHoursSunday")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal>("OvertimeHoursWeekday")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");
            ...
            modelBuilder.Entity("HR.Domain.OvertimeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HR.Domain.SalaryStructure", b =>
                {
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("IX_SalaryStructure_EmployeeId");
            ...
            modelBuilder.Entity("HR.Domain.Allowance", b =>
                {
                    b.HasOne("HR.Domain.Employee", null)
                        .WithMany("Allowances")
            ...
            modelBuilder.Entity("HR.Domain.PayrollLineItem", b =>
                {
                    b.HasOne("HR.Domain.Payroll", null)
                        .WithMany("LineItems")
