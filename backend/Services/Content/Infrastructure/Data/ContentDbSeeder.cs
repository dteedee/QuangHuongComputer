...
public class ContentDbSeeder
{
    ...
    public async Task SeedAsync()
    {
        ...
        if (!await _context.Coupons.AnyAsync())
        {
            ...
            {
                new Coupon("WELCOME10", "Welcome Discount", DiscountType.Percentage, 10, 0, null, DateTime.UtcNow, DateTime.UtcNow.AddYears(1)),
                new Coupon("SUMMER24", "Summer Sale", DiscountType.FixedAmount, 50000, 100000, null, DateTime.UtcNow, DateTime.UtcNow.AddMonths(3)),
                new Coupon("VIPUSER", "VIP Discount", DiscountType.Percentage, 15, 0, 500000, DateTime.UtcNow, DateTime.UtcNow.AddYears(10))
            };
